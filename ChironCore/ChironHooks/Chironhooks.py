...
class ConcreteChironHooks(ChironHooks):
    ...
    def ChironStartHook(self, interpreterObj):
        ...
        tur.goto(170,200)
        tur.write("(250, 200)",font=("Verdana", 10, "normal"))
        tur.goto(170,300)
        tur.write("(250, 300)",font=("Verdana", 10, "normal"))
        tur.goto(270,360)
        tur.write("(300, 350)",font=("Verdana", 10, "normal"))
        tur.goto(370,300)
        tur.write("(350, 300)",font=("Verdana", 10, "normal"))
        tur.goto(370,200)
        tur.write("(350, 200)",font=("Verdana", 10, "normal"))
